...
1. Provere kandidata: izgradnja uspešna; svih 279 automatskih testova prolazi. Provera koda prolazi bez grešaka (dva ranija upozorenja). Držanje ekrana budnim proveriti na Android telefonu tokom očitavanja; automatizovani test ne može da potvrdi ponašanje konkretnog telefona i pregledača.
