  ...
  sr: {
    ...
    terms: {
      ...
      sections: [
        ...
        { heading: "Trajanje beta pristupa", paragraphs: ["Trenutna beta aplikacija nema automatsko ograničenje pristupa od 72 sata, ne zahteva platnu karticu i ne pretvara se automatski u naplatu."] },
    ...
    privacy: {
      ...
      sections: [
        ...
        { heading: "Postojeći demo kolačić", paragraphs: ["Ako je ranije pokrenut demo, server može čuvati tehnički HttpOnly kolačić za njegov početak. Trenutna beta aplikacija ne ograničava pristup na osnovu tog kolačića. On ne sadrži ime, e-mail, broj kartice vozača, registraciju ili lokaciju."] },
  ...
  en: {
    ...
    terms: {
      ...
      sections: [
        ...
        { heading: "Beta access period", paragraphs: ["The current beta app has no automatic 72-hour access limit, requires no payment card and does not automatically become a paid subscription."] },
    ...
    privacy: {
      ...
      sections: [
        ...
        { heading: "Existing demo cookie", paragraphs: ["If you started a demo previously, the server may retain a technical HttpOnly cookie marking its start. The current beta app does not restrict access based on that cookie. It contains no name, email address, driver card number, vehicle registration or location."] },
  ...
  de: {
    ...
    terms: {
      ...
      sections: [
        ...
        { heading: "Dauer des Beta-Zugangs", paragraphs: ["Die aktuelle Beta-App hat keine automatische Zugangsbeschränkung auf 72 Stunden, erfordert keine Zahlungskarte und wird nicht automatisch kostenpflichtig."] },
    ...
    privacy: {
      ...
      sections: [
        ...
        { heading: "Vorhandenes Demo-Cookie", paragraphs: ["Falls zuvor eine Demo gestartet wurde, kann der Server ein technisches HttpOnly-Cookie mit deren Beginn speichern. Die aktuelle Beta-App beschränkt den Zugang nicht anhand dieses Cookies. Es enthält weder Name, E-Mail-Adresse, Fahrerkartennummer, Kennzeichen noch Standort."] },
