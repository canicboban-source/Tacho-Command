import { parseAppV2CardPayload } from "./app-v2-canonical-card-parser.js";
...
export function handoffCanonicalAppV2CardPayload({
  payload,
  storage,
  capturedAtIso = new Date().toISOString(),
} = {}) {
  return handoffCompletedCardPayload({
    payload,
    parseCard: parseAppV2CardPayload,
    storage,
    capturedAtIso,
  });
}
