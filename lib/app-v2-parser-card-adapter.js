...
export function normalizeParserCardResult(input = {}) {
  ...
  const last14 = limitedDays.slice(-14);
  const fortnightDrivingMinutes = last14.reduce((sum, day) => sum + day.drivingMinutes, 0);
  ...
  return Object.freeze({
    ...
    historyRangeEndIso: limitedDays.at(-1)?.dateIso ?? null,
